<template>
  <div class="relative w-full min-h-screen flex justify-center items-center">
    ...
    <div
      class="relative z-10 w-[700px] bg-white/45 rounded-[70px] shadow-2xl p-8"
    >
      <div class="w-full h-full flex flex-col items-center gap-4">
        ...
        <div
          @click="gendercheck"
          class="flex text-white w-[500px] h-auto gap-[100px] ml-6"
        >
        ...
        >
          ...
          >
            <path
              fill="currentColor"
              d="M7 10h5v5H7zm7 0h3v5h-3zM7 3v2H5a2 2 0 0 0-2 2v12a2
        ...
        <button
          type="button"
          :disabled="loading"
          class="w-[500px] h-[45px] bg-[#A0E13E] text-white rounded-[70px] font-bold shadow-2xl cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          @click="gototag"
        >
        ...
        <div class="flex gap-4">
          ...
          <span class="text-[#A0E13E] cursor-pointer" @click="gotoLogin"
            >เข้าสู่ระบบ</span
          >
        </div>
      </div>
...
const form = ref({
  ...
  password: "",
  gender: "",
  birthdate: "", // 👉 ส่ง backend เป็น YYYY-MM-DD
  age: null,
});
...
onMounted(() => {
  flatpickr(birthInput.value, {
    locale: Thai,
    dateFormat: "d/m/Y", // ✅ แสดง วว/ดด/ปปปป
    disableMobile: true,
