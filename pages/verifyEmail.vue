<template>
  <div
    class="relative w-full min-h-screen flex justify-center items-center px-4"
  >
    <!-- BG -->
    <div
    ...
    <!-- CARD -->
    <div
      class="relative z-20 w-full max-w-[700px] bg-white/45 backdrop-blur-md rounded-[40px] sm:rounded-[70px] shadow-2xl p-5 sm:p-8"
    >
      <div class="flex flex-col items-center gap-4 text-center">
        <!-- TITLE -->
        <h1
          class="text-2xl sm:text-3xl md:text-4xl font-bold text-white text-shadow-2xl"
        >
          ยืนยันที่อยู่อีเมล
        </h1>
        ...
        <h2 class="text-sm sm:text-base md:text-lg text-white font-bold">
          ...
          กรุณาตรวจสอบและกรอกรหัสเพื่อดำเนินการต่อ
        </h2>
        ...
        <div class="flex gap-2 sm:gap-3">
          <input
            ...
            class="w-10 h-10 sm:w-12 sm:h-12 bg-[#DFF0B5] text-center text-xl sm:text-2xl font-bold rounded-md text-black outline-none focus:ring-2 focus:ring-[#A0E13E]"
          />
        </div>

        <!-- BUTTON -->
        <button
          class="w-full max-w-[500px] h-[45px] bg-[#A0E13E] text-white rounded-full font-bold shadow-2xl hover:bg-[#80b432]"
