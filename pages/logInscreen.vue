<template>
  <div
    class="relative w-full h-screen flex justify-center items-center bg-[url('/img/bglogin2.webp')] bg-cover bg-center">
    <div class="absolute inset-0 bg-black/50"></div>
    <img src="/img/logo.png" alt="" class="shadow-2xl w-[370px] h-[370px] absolute bottom-110 left-8 z-20" />
    <div class="w-[700px] h-[400px] bg-white/45 rounded-[70px] shadow-2xl relative z-20 p-5">
      <div class="w-full h-full flex flex-col items-center gap-4">
        ...
        <div
          ...
          </svg><input type="text" placeholder="อีเมล" v-model="form.email"
        ...
        <div
          ...
          <div @click="togglePassword" class="cursor-pointer">
            ...
            <svg v-if="showPassword" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512"
        ...
        <div class="flex justify-between items-center w-[500px]">
          <label class="flex items-center gap-2 cursor-pointer select-none">
            ...
            <!-- กล่อง checkbox -->
            <div class="w-5 h-5 rounded-sm border-2 border-gray-400 
             flex items-center justify-center transition-all
             peer-checked:border-white peer-checked:bg-white">

              <!-- ไอคอนถูก -->
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" class="opacity-0 peer-checked:opacity-100 
          ...
          <span class="text-white underline cursor-pointer hover:text-[#A0E13E]" @click="handlepassword">
            Forgot Password?
          </span>
        </div>
  ...
  <div class="flex gap-4">
    ...
    <span class="text-[#A0E13E] cursor-pointer" @click="handleRegister">สมัครบัญชี </span>
    <p v-if="errorMsg" class="text-red-500">
      {{ errorMsg }}
    </p>
  </div>
